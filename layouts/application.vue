...
<template>
  <div class="h-screen bg-lemon-50 dark:bg-dark-100">
    <div class="flex flex-col h-full mx-auto max-w-7xl relative">
      <q-app-bar v-if="accountStore.isLoggedIn" class="w-full top-0 left-0 z-10" :header="appBarHeader" />
